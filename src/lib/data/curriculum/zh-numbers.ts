...
export const zhNumbersCurriculum: CurriculumPhase[] = [
  {
    ...
    gameMode: 'reveal',
    newPhonemeIds: ['zh-yi1', 'zh-er4', 'zh-san1', 'zh-si4', 'zh-wu3'],
    words: [
  ...
  },
  {
    ...
    newPhonemeIds: [],
    words: [
      { id: 'zh-shiyi',  text: '十一', phonemeIds: ['zh-shi2', 'zh-yi1'],  meaning: 'eleven',   emoji: '1️⃣1️⃣' },
      { id: 'zh-shier',  text: '十二', phonemeIds: ['zh-shi2', 'zh-er4'],  meaning: 'twelve',   emoji: '1️⃣2️⃣' },
      { id: 'zh-shisan', text: '十三', phonemeIds: ['zh-shi2', 'zh-san1'], meaning: 'thirteen', emoji: '1️⃣3️⃣' },
